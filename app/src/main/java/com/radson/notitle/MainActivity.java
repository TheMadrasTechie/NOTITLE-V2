...
public class MainActivity extends Click  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalvalue();
        //final TextView tittle = (TextView)findViewById(R.id.leveltittle);
        //if(sharedPreferences.getInt("layoutname",0)==0){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename", 0));}else
        //if(sharedPreferences.getInt("layoutname",1)==1){tittle.setText("Level "+sharedPreferences.getInt("1Leveltittlename", 0));}else
        //if(sharedPreferences.getInt("layoutname",0)==2){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename2", 0));}else
        //if(sharedPreferences.getInt("layoutname",0)==3){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename3", 0));}else
        //if(sharedPreferences.getInt("layoutname",0)==4){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename4", 0));}else
        //if(sharedPreferences.getInt("layoutname",0)==5){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename5", 0));}else
        //if(sharedPreferences.getInt("layoutname",0)==6){tittle.setText("Level "+sharedPreferences.getInt("Leveltittlename6", 0));}
